<html>
<head>
<title>AFFILIAZIONE INTERNAZIONALE</title>
...
function isReady(form) {
		...
		var counter = 0
		if (form.ID_Name.value != "") counter ++;
        if (form.ID_Company.value != "") counter ++;
        if (form.ID_Phone.value != "") counter ++;
        if (form.ID_Title.value != "") counter ++;
		if (form.ID_State.value != "") counter ++;
		if (form.sender.value != "") counter ++;
        if (counter != 6) {
                alert("Please make sure you have filled in all required fields.");
                form.ID_Company.focus();
                return false;
                }
         else {
		    if ((form.SUR_Contact_By_Phone[0].checked || form.SUR_Contact_By_Phone[1].checked)&& (form.SUR_Contact_By_Email[0].checked || form.SUR_Contact_By_Email[1].checked)) {
				
				if ((form.SUR_Where_Heard.options[form.SUR_Where_Heard.selectedIndex].value=="boo") || (form.SUR_Company_Size.options[form.SUR_Company_Size.selectedIndex].value=="boo")){
    			...
    			alert("Please select an option to be contacted by phone or e-mail.");
				return false;
			}
		  return true;
        }       
...
.style44 {font-family: Arial, Helvetica, sans-serif; font-weight: bold; font-size: 12pt; color: #FFFF00; }
  ...
  <table width="700" border="8" height="1131">
    <tr> 
			  ...
			  <table width="100%" border="2" cellpadding="5" cellspacing="5">
                <tr bgcolor="#72060B">
                  <td colspan="5" bgcolor="#04187B"><div align="center" class="Stile53">
                    <div align="center" class="Stile53">
                      <table width="100%"  border="8" bgcolor="#04187B">
                        <tr>
                          <td><div align="center"><img src="http://www.interfreezone.org/db/SITOEXPORTER/img/supporting.jpg" width="605" height="40"></div></td>
                        </tr>
                      </table>
                    </div>
                  </div></td>
                                ...
                                <td valign="top" bgcolor="#FFFF99"><table width="100%" border="10">
                                  <tr>
                                    <td valign="top"><table width="100%" border="0" cellspacing="5" bordercolor="#CCFFCC" bgcolor="#CCFFCC">
                                      ...
                                      <tr>
                                        <td colspan="2"><table width="100%" border="5" cellspacing="0" cellpadding="5">
                                          <tr>
                                            <td bgcolor="#000099"><div align="center"><span id="sez1" class="Stile53"><span class="Stile94"><span class="style44" id="sez1">BACHECA DOCUMENTALE</span></span></span></div></td>
                                          </tr>
                                        </table></td>
                                      </tr>
                                      <tr>
                                        <td colspan="2"><table width="100%" border="5" cellpadding="2" cellspacing="2" bgcolor="#CCCCCC">
                                          <tr>
                                            ...
                                            <td colspan="2" valign="top" bgcolor="#FFFFCC"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                  <td><table width="100%" border="1" cellspacing="2" cellpadding="2">
                                                      <tr>
                                                        <td bordercolor="#000033" bgcolor="#E0DFE3"><span class="style10 Stile9 Stile9"><a href="http://www.interfreezone.org/DB/SITOEXPORTER/PAGES/PDF/CANDELORO CV.PDF" target="_blank" class="titolo"><strong><img src="http://www.interfreezone.org/webmarketing/IMG/ball.gif" width="14" height="14" border="0" /></strong></a><a href="http://www.interfreezone.org/db/sitoexporter/pages/sez2org.htm" target="_blank"></a>Link for more details</span></td>
                                                      </tr>
                                                  </table></td>
                                                </tr>
                                            </table></td>
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="2" valign="top" bgcolor="#FFFFCC"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                                ...
                                                <tr>
                                                  <td><table width="100%" border="1" cellspacing="2" cellpadding="2">
                                                      <tr>
                                                        <td bordercolor="#000033" bgcolor="#E0DFE3"><span class="style10 Stile9 Stile9">
                                                        <?php
                                            ...
                                            switch ($lang){
                                                ...
                                                default:
                                                   ...
                                                   $Linguabro="ITALIANO";
                                                    // italiano per tutti gli altri casi di rilevamento della lingua
                                                    break;
                                                
                                            }
                                            ?>
                                                        <a href="http://inter-markets-secure-procurement.com/itfz/00<?php echo $Linguabro; ?>/1_ptp.htm" target="_blank"><img src="http://www.interfreezone.org/db/sitoexporter/img/ball.gif" border="0">
                                                        
                                                        </a>
                                                        
                                                        
                                                        
                                                        Link for more details</span></td>
                                                      </tr>
                                                  </table></td>
                                                </tr>
                                            </table></td>
                                            ...
                                            <td colspan="4"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#000066">
                                              <tr>
                                                ...
                                                <td width="90%" class="style5"><div align="left">
                                                    <table width="100%" border="0" cellspacing="0" cellpadding="4">
                                                      <tr>
                                                        <td class="style33"><div align="justify"></div></td>
                                                      </tr>
                                                    </table>
                                                </div></td>
                                              </tr>
                                          ...
                                          <tr>
                                            ...
                                            <td colspan="2" valign="top" bgcolor="#FFFFCC"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                                              ...
                                              <tr>
                                                <td><table width="100%" border="1" cellspacing="2" cellpadding="2">
                                                    <tr>
                                                      <td bordercolor="#000033" bgcolor="#E0DFE3"><span class="style10 Stile9 Stile9"><a href="http://inter-markets-secure-procurement.com/itfz/00<?php echo $Linguabro; ?>/list_imps.htm" target="_blank"><img src="http://www.interfreezone.org/db/sitoexporter/img/ball.gif" border="0"></a>Link for more details</span></td>
                                                    </tr>
                                                  </table></td>
                                              </tr>
                                            </table></td>
                                ...
                                <td bgcolor="#FFFFCC"><table width="100%" border="0" cellspacing="5" bordercolor="#ECE9D8" bgcolor="#FFFFCC">
                                    <tr>
                                      <td width="50%" valign="middle"><table border="0" cellspacing="0">
                                          <tr>
                                            <td><a href="info-form.htm" target="_blank"><img src="http://www.interfreezone.org/db/sitoexporter/img/ball.gif" border="0"><img src="http://www.interfreezone.org/db/sitoexporter/img/british_flag.gif" border="0"></a></td>
                                            <td><span class="Stile101">Click for more details </span></td>
                                          </tr>
                                      </table></td>
                                      <td width="54%"><table border="0" cellspacing="5">
                                          <tr>
                                            <td><a href="info-form.htm" target="_blank"><img src="http://www.interfreezone.org/db/sitoexporter/img/ball.gif" border="0"><img src="http://www.interfreezone.org/db/sitoexporter/img/italian_flag.gif" border="0"></a></td>
                ...
                <tr>
                  <td bgcolor="#FFFF99" colspan="5"><div align="center"><font face="Arial, Helvetica, sans-serif" size="2" color="#000066"><b><font color="#FFFFFF" size="5"> </font></b></font>
                    <table width="100%" border="4">
                      ...
                      <div align="center">
                        <p class="Stile81 Stile99">Copyright© Inter-Markets-Associates-Network-Swiss-Geneve-Lugano &amp; Milan-Italy</p>
                    </div></td>
                </tr>
              </table></td>
    </tr>
