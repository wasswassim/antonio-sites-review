                ...
                <tr bgcolor="#72060B">
                  <td colspan="5" bgcolor="#003300"><div align="center" class="Stile53">
                    <table width="100%" border="0">
                      ...
                      <tr>
                        <td><div align="center"><span class="Stile27"><a href="https://inter-freezone.website/ifree/db/SITOEXPORTER/img/TELEPORTO-NY+AC.jpg" target="_blank"><img src="https://inter-freezone.website/ifree/db/SITOEXPORTER/img/TELENY.jpg"></a></span></div></td>
                  ...
                  <table width="100%" border="5" cellpadding="5" cellspacing="0" bgcolor="#FFFFCC">
                    <tr>
                      <td bgcolor="#000066"><div>
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                              <td colspan="2"><strong><a href="http://www.interfreezone.org/SAUDI-ARABIA-EXHIBITS/ac-cv-index.html" target="_blank"><img src="http://www.interfreezone.org/db/SITOEXPORTER/img/ball.gif" width="14" height="14" border="0"></a>W1&nbsp; -&nbsp;&nbsp;TEAM of EXPORT-IMPORT MANAGEMENT SUPPORT </strong></td>
                            </tr>
                            <tr>
                              <td width="6%">&nbsp;</td>
