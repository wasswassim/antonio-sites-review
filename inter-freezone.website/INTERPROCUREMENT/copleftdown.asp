...
'		Response.Write(rsPr.fields("codice"))
		Response.Redirect("http://www.interfreezone.org/db/copleftdown.asp?recordset1_Action=Find('codice','" & rsPr.fields("Codice") & "')&Recordset1_Position=FIL%3AORD%3AABS%3A1KEY%3A" & rsPr.fields("Codice") & "PAR%3A") 
	end if
%>